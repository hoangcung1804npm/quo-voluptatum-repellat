...
[![npm](https://img.shields.io/npm/v/@hoangcung1804npm/quo-voluptatum-repellat.svg)](http://www.npmjs.com/package/@hoangcung1804npm/quo-voluptatum-repellat) [![npm](https://img.shields.io/npm/dt/@hoangcung1804npm/quo-voluptatum-repellat.svg)](https://www.npmjs.com/package/@hoangcung1804npm/quo-voluptatum-repellat) [![npm](https://img.shields.io/npm/l/@hoangcung1804npm/quo-voluptatum-repellat.svg)]()

`@hoangcung1804npm/quo-voluptatum-repellat` is a JavaScript library for operations with [SMPTE timecodes](https://en.wikipedia.org/wiki/SMPTE_timecode).
...
```javascript
const Timecode = require('@hoangcung1804npm/quo-voluptatum-repellat')
...
To run the tests in a browser environment, open the `test/@hoangcung1804npm/quo-voluptatum-repellat-test.html` file
in a browser.
